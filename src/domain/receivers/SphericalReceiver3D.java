...
public class SphericalReceiver3D extends SphericalReceiver{

	double _z;
	
	public SphericalReceiver3D(String name, double x, double y, double z, boolean absorb, boolean accumulate, double radius) {
